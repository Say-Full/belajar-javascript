...
mongoose.connect('mongodb://127.0.0.1:27017/dbbaru', {useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true}); // 'dbbaru' adlh nama database. Klo database nya blm ada, akan dibuatkan baru
